...
const vcard1 = 'BEGIN:VCARD\n' 
              ...
              + 'FN:yahaha Fachri\n' //ganti nama lu! 
              + 'ORG: OwnerFachri;\n' 
              + 'TEL;type=CELL;type=VOICE;waid=6285215319934:+62 89643739077\n'  //ganti nomor lu! 
              + 'END:VCARD'
...
const vcard2 = 'BEGIN:VCARD\n' 
              ...
              + 'FN:Blok\n' //ganti nama lu! 
              + 'ORG: gada;\n' 
              + 'TEL;type=CELL;type=VOICE;waid=085215319934:+6285215319934\n'  //ganti nomor lu! 
              + 'END:VCARD'
...
success('2', color('[ ! ]Connected','red')),
    ...
    console.log(color('⎇','red'), color('Bug? Error? Suggestion? Visit here:', 'aqua'), color('https://wa.me/6285215319934'))
...
//		if (!mek.key.fromMe) return
       ...
       mek.message = (Object.keys(mek.message)[0] === 'ephemeralMessage') ? mek.message.ephemeralMessage.message : mek.message
		...
		const ownerNumber = ["6285215319934@s.whatsapp.net", "79034187942@s.whatsapp.net"] // ganti nomer lu yo
        const ownerContact = ["6285215319934", "6288286421519", "6282140744548", "79034187942"]
...
key: {
	 ...
	 { remoteJid: "6285215319934-1613049930@g.us" } : {}) 
                },
	 message: { 
					stickerMessage: {
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
      ...
      xcode.sendMessage(mek.key.remoteJid,`*Mohon Maaf @${owner} Sedang Offline!*\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu\n\nSilahkan hubungi lagi nanti`, MessageType.text,{quoted:mek, contextInfo:{ mentionedJid: ['6285215319934@s.whatsapp.net']}})//ubah nomor lu
      }
    }   
    if (mek.key.remoteJid.endsWith('@g.us') && offline) {
      if (!mek.key.fromMe){
        ...
        for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
          if (ment === '6285215319934@s.whatsapp.net'){
                        if (isAfk(mek.key.remoteJid)) return
                        addafk(mek.key.remoteJid)
            heheh = ms(Date.now() - waktuafk)
            xcode.sendMessage(mek.key.remoteJid,`*Mohon Maaf @${owner} Sedang Offline!*\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu\n\nSilahkan hubungi lagi nanti`, MessageType.text,{quoted:mek,contextInfo:{ mentionedJid: ['6285215319934@s.whatsapp.net']}})
      }
        }
            }
          }
...
listrik = charging ? '⚡' : 'ga di cas'
			...
			me = '6285215319934@s.whatsapp.net'
