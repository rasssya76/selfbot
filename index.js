...
⇒ ${prefix}rsticker Reply img
⇒ ${prefix}stickergif Reply video
⇒ ${prefix}stickerwa Query
⇒ ${prefix}stickerwm Nama|Author
⇒ ${prefix}stickmeme Teks
⇒ ${prefix}stickmeme2 Teks
⇒ ${prefix}stickmeme3 tks ats|tks bwh
⇒ ${prefix}stickwasted rply stk
⇒ ${prefix}stickflip rply stk
⇒ ${prefix}sticknobg 
⇒ ${prefix}nobg Reply img
⇒ ${prefix}ttp Text
⇒ ${prefix}ttp1Text
...
*◪* *CONVERT*
⇒ ${prefix}textmaker atas|bawah
⇒ ${prefix}fdeface Url|title|desk
⇒ ${prefix}fake Url|title|desk
⇒ ${prefix}togif Reply stickergif
...
*◪* 𝗧𝗔𝗚
⇒ ${prefix}sendkontag nama
⇒ ${prefix}hidetag Text
⇒ ${prefix}stctag Tag Stc
⇒ ${prefix}imgtag Tag Img
⇒ ${prefix}kontak nama|nomor
⇒ ${prefix}kontag nama|nomor
